...
urlpatterns = [
    ...
    path('venta_galpones/', views.venta_galpones ,name ="venta_galpones"),
    ...
    path('galpones_detail_ventas/<int:post_id>/', views.galpones_detail_ventas, name = "galpones_detail_ventas")
